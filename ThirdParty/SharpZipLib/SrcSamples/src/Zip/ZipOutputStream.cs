...
namespace ICSharpCode.SharpZipLib.Zip
{
	...
	public class ZipOutputStream : DeflaterOutputStream
	{
	    ...
	    /// <summary>
	    /// Writes pre-compressed data to the stream. Use this only if you know what you're doing.
	    /// </summary>
	    /// <param name="buffer">The buffer containing data to write.</param>
	    /// <param name="offset">The offset of the first byte to write.</param>
	    /// <param name="count">The number of bytes to write.</param>
	    /// <param name="checksum">The CRC32 checksum of the decompressed file content about to be written.</param>
	    ...
	    public void WriteCompressed(byte[] buffer, int offset, int count, long checksum)
        {
            if (curEntry == null)
            {
                throw new InvalidOperationException("No open entry.");
